...
Soho UI is a design system is a cross-platform component library for React and React Native. Soho UI has high adoption in every product at Coinbase, accelerating development and ensuring a consistent user experience across all platforms.

## Key features

- **Cross-platform** - Soho UI provides components for both React DOM and React Native. We go to great lengths to ensure that the source code is as identical as possible across React and React Native without compromising on platform-specific features.
...
Soho UI is designed to make your development workflow as smooth as possible.
